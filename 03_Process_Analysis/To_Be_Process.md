...
Requests can be categorized using elapsed SLA time:
...
The actual improvement percentage will not be assumed. It will be estimated after the baseline analysis and scenario modelling are completed.
